...
void get_possible_moves(board_t *board, unsigned char color, int row, int column, move_t moves[]);
...
void get_possible_moves_knight(board_t *board, unsigned char color, int row, int column, move_t moves[]);
